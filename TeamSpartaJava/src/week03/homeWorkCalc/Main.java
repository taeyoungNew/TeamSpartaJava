...
public class Main {
	...
	public static void main(String[] args) {
		// Calcater에서
//		Caculater calc = new Caculater(new AddOperation());
		
		Caculater calc = new Caculater(null);
		
		calc.setOperaion(new AddOperation());
		
		double answer = calc.calculate(12, 320);
		System.out.println(answer);
		
		calc = new Caculater(new DivideOperation());
		answer = calc.calculate(12, 110);
		System.out.println(answer);
	}
